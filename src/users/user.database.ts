...
//constant function findall is async with no params and return type promise<UnitUser> the function returns the values of the users object
export const findOne = async (id: string): Promise<UnitUser> => users[id];
//exporting a functtion to find one user with a single param id of type string with return type promise unit user the funtion returns the UnitUser at users at index id
